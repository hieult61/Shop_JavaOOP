...
public class SupplierDashboard extends JFrame {
	...
	////////////////////////////////////
	public static JLabel lblNewLabel_deli;
	...
	public SupplierDashboard() {
		...
		lblNewLabel_deli = new JLabel("0");
		lblNewLabel_deli.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_deli.setBounds(153, 52, 49, 14);
		panel_6.add(lblNewLabel_deli);
